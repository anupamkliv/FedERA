...
def create_train_test_for_fedavg():
    ...
    class TrainerTest(unittest.TestCase):
        @classmethod
        def setUpClass(cls):
            config = get_config('test_mini', 'fedavg')
...
def create_train_test_for_fedadam():
    ...
    class TrainerTest(unittest.TestCase):
        @classmethod
        def setUpClass(cls):
            config = get_config('test_mini', 'fedadam')
            save_intial_model(config['server'])
...
def create_train_test_for_verification_module():
    ...
    class TrainerTest(unittest.TestCase):
        @classmethod
        def setUpClass(cls):
            config = get_config('test_mini', 'verification')
            save_intial_model(config['server'])
...
def create_train_test_for_timeout_module():
    ...
    class TrainerTest(unittest.TestCase):
        @classmethod
        def setUpClass(cls):
            config = get_config('test_mini', 'timeout')
            save_intial_model(config['server'])
...
def create_train_test_for_intermediate_connection_module():
    ...
    class TrainerTest(unittest.TestCase):
        @classmethod
        def setUpClass(cls):
            config = get_config('test_mini', 'intermediate')
            save_intial_model(config['server'])
